...
> [**mailroom**](https://github.com/tetsuo/mailroom/) demonstrates how to manage account lifecycles and batch-process operations—such as activation and password resets—using PostgreSQL triggers and notifications.
